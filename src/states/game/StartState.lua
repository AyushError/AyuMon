    ...
    if love.keyboard.wasPressed('enter') or love.keyboard.wasPressed('return') then
        ...
        function()
            ...
            gStateStack:push(DialogueState("" .. 
                "Welcome to the world of AyuMon! To start fighting monsters with your own randomly assigned" ..
...
function StartState:render()
    ...
    love.graphics.printf('AyuMon!', 0, VIRTUAL_HEIGHT / 2 - 72, VIRTUAL_WIDTH, 'center')
